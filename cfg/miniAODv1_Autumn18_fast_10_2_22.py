...
# with command line options: --python_filename fast_miniAODSIM.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:miniAODSIM.root --conditions 102X_upgrade2018_realistic_v15 --step PAT --geometry DB:Extended --filein file:reco_FastSim_LO_0j_102X_CP5_FastSim.root --era Run2_2018 --fast --runUnscheduled --no_exec --mc -n 100
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('PAT',eras.Run2_2018,eras.fastSim)
