...
#config.Data.splitting = 'FileBased' if "IS_DATA" in os.environ else 'LumiBased'
if "CRAB_IS_DATA" == True :
...
if "IS_DATA" in os.environ:
	if "2016" in Run:
		...
		print "2017 json: "
		config.Data.lumiMask = '/users/priya.hussain/private/CMSSW_10_6_25/src/Samples/Tools/data/json/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt'
	elif "2018" in Run:
		print "2018 json: "
		config.Data.lumiMask = '/users/priya.hussain/private/CMSSW_10_6_25/src/Samples/Tools/data/json/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'
