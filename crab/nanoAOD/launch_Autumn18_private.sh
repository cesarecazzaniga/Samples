...
python launch.py $@ --sorted --runOnLocal --config nano_mc_102X_Autumn18_miniAODv1 --production_label legacy_nano_v3 --remoteDir legacy_nano_v3 --unitsPerJob 50 --publish --module Autumn18_private --sample ttZ01j_3l_EFT_lepWFilter #SPLIT20
python launch.py $@ --sorted --runOnLocal --config nano_mc_102X_Autumn18_miniAODv1 --production_label legacy_nano_v3 --remoteDir legacy_nano_v3 --unitsPerJob 50 --publish --module Autumn18_private --sample tWZToLL01j_3l_EFT_lepWFilter #SPLIT20
