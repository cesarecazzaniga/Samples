...
#WZTo3LNu_NLO		= FWLiteSample.fromDAS("WZTo3LNu_NLO",   "/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/", dbFile=dbFile, overwrite=ov, prefix=redirector_global, skipCheck=True)
...
#ttWJetsToQQ_NLO			= FWLiteSample.fromDAS("ttWJetsToQQ_NLO",   "/TTWJetsToQQ_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/", 	dbFile=dbFile, overwrite=ov, prefix=redirector_global, skipCheck=True)
...
#
###QCD
QCD_HT50to100			= FWLiteSample.fromDAS("QCD_HT50to100",     "/QCD_HT500to700_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8/RunIISummer20UL16MiniAODAPVv2-106X_mcRun2_asymptotic_preVFP_v11-v1/MINIAODSIM", 	dbFile=dbFile, overwrite=ov, prefix=redirector_global, skipCheck=True)
